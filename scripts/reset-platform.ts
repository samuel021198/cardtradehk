...
const EXTRA: CatalogItem[] = [
  ...
  { title: "One Piece OP-05 Booster Box (JP)", game: "ONE_PIECE", cardType: "SEALED", condition: "BOX", priceHkd: 1280, description: "日版新時代的主角 原盒未拆，膠膜完整。", imageUrl: "https://limitlesstcg.nyc3.cdn.digitaloceanspaces.com/one-piece/OP05/OP05-119_EN.webp" },
  { title: "One Piece OP-09 Booster Box (EN)", game: "ONE_PIECE", cardType: "SEALED", condition: "BOX", priceHkd: 980, description: "英文 Emperors in the New World 原盒。", imageUrl: "https://limitlesstcg.nyc3.cdn.digitaloceanspaces.com/one-piece/OP01/OP01-120_EN.webp" },
  { title: "One Piece Premium Card Collection", game: "ONE_PIECE", cardType: "SEALED", condition: "ACCESSORY", priceHkd: 420, description: "官方收藏冊未開封。", imageUrl: "https://limitlesstcg.nyc3.cdn.digitaloceanspaces.com/one-piece/OP01/OP01-002_EN.webp" },
  ...
  { title: "Sanji OP07-064 Super Rare", game: "ONE_PIECE", cardType: "RAW", condition: "A", priceHkd: 140, description: "Sanji SR，近全新。", imageUrl: "https://limitlesstcg.nyc3.cdn.digitaloceanspaces.com/one-piece/OP07/OP07-064_EN.webp" },
  { title: "Nico Robin OP05-051", game: "ONE_PIECE", cardType: "RAW", condition: "A", priceHkd: 110, description: "Robin SR。", imageUrl: "https://limitlesstcg.nyc3.cdn.digitaloceanspaces.com/one-piece/OP05/OP05-051_EN.webp" },
  { title: "Crocodile OP08-062", game: "ONE_PIECE", cardType: "RAW", condition: "B", priceHkd: 85, description: "Crocodile，角位微白。", imageUrl: "https://limitlesstcg.nyc3.cdn.digitaloceanspaces.com/one-piece/OP08/OP08-062_EN.webp" },
